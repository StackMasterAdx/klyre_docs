...
const variantStyles = {
  primary:
    ...
    'rounded-full bg-gray-500 py-1 px-3 text-white hover:bg-gray-700 dark:bg-white dark:text-gray-500 dark:ring-1 dark:ring-inset dark:ring-white dark:hover:bg-gray-100 dark:hover:text-gray-700 dark:hover:ring-gray-100',
  secondary:
  ...
  text: 'text-gray-700 hover:text-gray-950 dark:text-gray-300 dark:hover:text-gray-400',
}
